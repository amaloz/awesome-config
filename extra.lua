-- Based on code from https://github.com/tdy/awesome --
...
vicious.register(txgraph, vicious.widgets.net, "${" .. netname .. " up_kb}")

txwidget = wibox.widget.textbox()
vicious.register(txwidget, vicious.widgets.net,
                 "<span color='" .. beautiful.fg_em .. "'>tx</span>${" .. netname .. " tx_mb}MB", 19)
...
vicious.register(txwidget, vicious.widgets.net, "${" .. netname .. " up_kb}", 2)
...
vicious.register(rxgraph, vicious.widgets.net, "${" .. netname .. " down_kb}")

rxwidget = wibox.widget.textbox()
vicious.register(rxwidget, vicious.widgets.net,
                 "<span color='" .. beautiful.fg_em .. "'>rx</span>${" .. netname .. " rx_mb}MB", 17)
...
vicious.register(rxwidget, vicious.widgets.net, "${" .. netname .. " down_kb}", 2)
...
wifipct = wibox.widget.textbox()
vicious.register(
   wifipct, vicious.widgets.wifi,
   function(widget, winfo)
      if winfo["{link}"] == 0 then
