...
vicious.register(txgraph, vicious.widgets.net, "${wlp5s0 up_kb}")

-- TX total
txwidget = wibox.widget.textbox()
vicious.register(txwidget, vicious.widgets.net,
                 "<span color='" .. beautiful.fg_em .. "'>tx</span>${wlp5s0 tx_mb}MB", 19)
...
vicious.register(txwidget, vicious.widgets.net, "${wlp5s0 up_kb}", 2)
...
vicious.register(rxgraph, vicious.widgets.net, "${wlp5s0 down_kb}")

-- RX total
rxwidget = wibox.widget.textbox()
vicious.register(rxwidget, vicious.widgets.net,
                 "<span color='" .. beautiful.fg_em .. "'>rx</span>${wlp5s0 rx_mb}MB", 17)
...
vicious.register(rxwidget, vicious.widgets.net, "${wlp5s0 down_kb}", 2)
-- }}}
